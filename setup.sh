...
apt-get update
apt-get install -y cups libcups2-dev libusb-1.0-0-dev build-essential wget xsltproc xz-utils iw
...
cp "$SCRIPT_DIR/resetRig.sh" "$PI_HOME/"
